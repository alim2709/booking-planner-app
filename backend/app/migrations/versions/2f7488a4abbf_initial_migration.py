...
Revision ID: 2f7488a4abbf
Revises: 
Create Date: 2024-11-27 11:44:47.700195
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('COACH', 'STUDENT', name='userrole'), nullable=False),
